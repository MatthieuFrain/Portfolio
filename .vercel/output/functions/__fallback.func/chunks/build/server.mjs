...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "min-h-screen flex flex-col justify-center items-start px-6 md:px-20 max-w-7xl mx-auto pt-32" }, _attrs))}><div class="space-y-8 animate-fade-in-up"><h1 class="font-display text-6xl md:text-9xl font-bold tracking-tighter leading-none whitespace-pre-line"><span class="block text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-violet-400 to-blue-400 animate-aurora bg-[length:200%_auto]">${ssrInterpolate(unref(t).hero.title)}</span></h1><p class="text-2xl md:text-4xl text-zinc-400 max-w-3xl font-light tracking-wide">${ssrInterpolate(unref(t).hero.subtitle)}</p><div class="pt-8 flex gap-6"><a href="#works" class="group relative px-8 py-4 bg-white text-zinc-950 rounded-full font-medium text-lg overflow-hidden transition-all hover:scale-105"><div class="absolute inset-0 bg-gradient-to-r from-indigo-400 to-violet-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div><span class="relative z-10 group-hover:text-white transition-colors">${ssrInterpolate(unref(t).hero.cta)}</span></a></div></div><a href="#works" class="absolute bottom-12 left-1/2 -translate-x-1/2 animate-bounce opacity-50 cursor-pointer hover:opacity-100 transition-opacity"><div class="w-px h-12 bg-gradient-to-b from-transparent via-zinc-400 to-transparent"></div></a></section>`);
    };
  }
};
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({
        id: "dna",
        class: "py-20 px-6 md:px-20 max-w-7xl mx-auto"
      }, _attrs))}><h2 class="font-display text-4xl md:text-6xl font-bold text-white mb-12 tracking-tight">${ssrInterpolate(unref(t).about.title)}</h2><div class="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[300px]"><div class="group relative p-8 rounded-3xl bg-zinc-900 border border-white/5 overflow-hidden hover:border-indigo-500/30 transition-colors"><div class="absolute inset-0 bg-gradient-to-br from-indigo-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div><div class="relative z-10 h-full flex flex-col justify-between"><div class="p-3 bg-zinc-950 rounded-2xl w-fit border border-white/5">`);
      _push(ssrRenderComponent(unref(Terminal), { class: "w-8 h-8 text-indigo-400" }, null, _parent));
      _push(`</div><div><h3 class="text-2xl font-bold text-white mb-2">${ssrInterpolate(unref(t).about.hacker.title)}</h3><p class="text-zinc-400">${ssrInterpolate(unref(t).about.hacker.desc)}</p></div></div></div><div class="group relative p-8 rounded-3xl bg-zinc-900 border border-white/5 overflow-hidden md:col-span-2 hover:border-violet-500/30 transition-colors"><div class="absolute inset-0 bg-gradient-to-br from-violet-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div><div class="relative z-10 h-full flex flex-col justify-between"><div class="p-3 bg-zinc-950 rounded-2xl w-fit border border-white/5">`);
      _push(ssrRenderComponent(unref(Layers), { class: "w-8 h-8 text-violet-400" }, null, _parent));
      _push(`</div><div><h3 class="text-2xl font-bold text-white mb-2">${ssrInterpolate(unref(t).about.builder.title)}</h3><p class="text-zinc-400 max-w-xl">${ssrInterpolate(unref(t).about.builder.desc)}</p></div></div></div><div class="group relative p-8 rounded-3xl bg-zinc-900 border border-white/5 overflow-hidden md:col-span-2 hover:border-emerald-500/30 transition-colors"><div class="absolute inset-0 bg-gradient-to-br from-emerald-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div><div class="relative z-10 h-full flex flex-col justify-between"><div class="p-3 bg-zinc-950 rounded-2xl w-fit border border-white/5">`);
      _push(ssrRenderComponent(unref(Activity), { class: "w-8 h-8 text-emerald-400" }, null, _parent));
      _push(`</div><div><h3 class="text-2xl font-bold text-white mb-2">${ssrInterpolate(unref(t).about.resilient.title)}</h3><p class="text-zinc-400 max-w-xl">${ssrInterpolate(unref(t).about.resilient.desc)}</p></div></div></div><div class="group relative p-8 rounded-3xl bg-zinc-900 border border-white/5 overflow-hidden hover:border-blue-500/30 transition-colors"><div class="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div><div class="relative z-10 h-full flex flex-col justify-between"><div class="p-3 bg-zinc-950 rounded-2xl w-fit border border-white/5">`);
      _push(ssrRenderComponent(unref(Cpu), { class: "w-8 h-8 text-blue-400" }, null, _parent));
      _push(`</div><div><h3 class="text-2xl font-bold text-white mb-2">${ssrInterpolate(unref(t).about.pilot.title)}</h3><p class="text-zinc-400">${ssrInterpolate(unref(t).about.pilot.desc)}</p></div></div></div></div></section>`);
    };
  }
};
