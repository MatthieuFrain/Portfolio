<template>
  <section class="min-h-screen flex flex-col justify-center items-center md:items-start px-6 md:px-20 max-w-7xl mx-auto pt-32 md:pt-48 pb-48 md:pb-32 text-center md:text-left">
